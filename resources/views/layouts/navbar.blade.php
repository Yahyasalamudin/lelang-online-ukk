        ...
        @if (auth()->user()->role != 'pengguna')
            <div class="sidenav-header">
                ...
                <a class="navbar-brand m-0" href=" /dashboard">
                    ...
                    <span class="ms-1 font-weight-bold">Lelang <b>Online</b></span>
                </a>
            </div>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark fw-bold {{ Route::is('lelang.index') ? 'active' : '' }}"
                            ...
                            <span class="nav-link-text ms-1">Pelelangan</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="navbar-nav  justify-content-end">
                            <li class="nav-item d-flex align-items-center">
                                <a href="{{ route('editprofile', auth()->user()->id) }}"
                                    class="nav-link text-dark fw-bold font-weight-bold px-0">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="copyright text-center text-sm text-muted text-lg-start">
                        ...
                        <a href="https://www.instagram.com/yahya_.aaa/" class="font-weight-bold"
                            target="_blank">Yahya Salamudin</a>
